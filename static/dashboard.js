...
const THEMES = [
  ...
  { id: "dark-default", label: "Padrão", group: "dark", bg: "#121720", sidebarBg: "#0c0f17", cardBg: "#1d232f", accent: "#8bc34a" },
  { id: "dark-meianoite", label: "Meia-noite", group: "dark", bg: "#151520", sidebarBg: "#0e0e17", cardBg: "#20202e", accent: "#9d6fe0" },
  { id: "dark-carvao", label: "Carvão", group: "dark", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#6b93c9" },
  { id: "dark-cobre", label: "Cobre", group: "dark", bg: "#171618", sidebarBg: "#0f0e10", cardBg: "#232223", accent: "#c97d4a" },
  { id: "dark-safira", label: "Safira", group: "dark", bg: "#111620", sidebarBg: "#0b0f16", cardBg: "#1c2331", accent: "#3b82f6" },
  ...
  { id: "dark-cyber", label: "Cyber", group: "neon", bg: "#0f151a", sidebarBg: "#090d10", cardBg: "#182128", accent: "#22d3ee", gradient: "linear-gradient(135deg, #22d3ee 0%, #0ea5e9 55%, #6366f1 100%)" },
  { id: "dark-hacker", label: "Hacker", group: "neon", bg: "#0e1214", sidebarBg: "#090b0c", cardBg: "#18201f", accent: "#39ff88", gradient: "linear-gradient(135deg, #a3ff5c 0%, #39ff88 55%, #10d68a 100%)" },
  { id: "dark-lava", label: "Lava", group: "neon", bg: "#151213", sidebarBg: "#0e0b0d", cardBg: "#211c1c", accent: "#fb923c", gradient: "linear-gradient(135deg, #fbbf24 0%, #fb923c 55%, #f43f5e 100%)" },
  { id: "dark-fucsia", label: "Fúcsia", group: "neon", bg: "#151219", sidebarBg: "#0e0b11", cardBg: "#211b25", accent: "#ec4899", gradient: "linear-gradient(135deg, #f472b6 0%, #ec4899 50%, #db2777 100%)" },
];
