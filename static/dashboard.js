...
const THEMES = [
  ...
  { id: "dark-default", label: "Padrão", group: "dark", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#8bc34a" },
  { id: "dark-meianoite", label: "Meia-noite", group: "dark", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#9d6fe0" },
  { id: "dark-carvao", label: "Carvão", group: "dark", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#6b93c9" },
  { id: "dark-cobre", label: "Cobre", group: "dark", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#c97d4a" },
  { id: "dark-safira", label: "Safira", group: "dark", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#3b82f6" },
  ...
  { id: "dark-cyber", label: "Cyber", group: "neon", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#22d3ee", gradient: "linear-gradient(135deg, #22d3ee 0%, #0ea5e9 55%, #6366f1 100%)" },
  { id: "dark-hacker", label: "Hacker", group: "neon", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#39ff88", gradient: "linear-gradient(135deg, #a3ff5c 0%, #39ff88 55%, #10d68a 100%)" },
  { id: "dark-lava", label: "Lava", group: "neon", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#fb923c", gradient: "linear-gradient(135deg, #fbbf24 0%, #fb923c 55%, #f43f5e 100%)" },
  { id: "dark-fucsia", label: "Fúcsia", group: "neon", bg: "#14171c", sidebarBg: "#0d0f13", cardBg: "#1f2329", accent: "#ec4899", gradient: "linear-gradient(135deg, #f472b6 0%, #ec4899 50%, #db2777 100%)" },
];
